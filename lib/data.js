...
export const ELEKTRO = {
  DNX6: {
    label: 'DN-X6',
    brand: 'Easy Diagnosis DN-X6 — Elektrolit (Na/K/Cl/Ca/pH/Li)',
    dP: 99960000, dK: 0, dM: 0, dT: 0,
    testPresets: [100, 200, 300, 500, 700, 1000],
    modes: {
      cartridge: { label: 'Cartridge Type', calAVol: 650,  price: 4736000  },
      bottle:    { label: 'Bottle Type',    calAVol: 1350, price: 5832000  },
    },
    qcItems: [
      { id: 'qc1', fn: 'QC Solution 1', pack: '1 btl/level', dp: 948000 },
      { id: 'qc2', fn: 'QC Solution 2', pack: '1 btl/level', dp: 948000 },
      { id: 'qc3', fn: 'QC Solution 3', pack: '1 btl/level', dp: 948000 },
    ],
    calc(tpm, wd, mode, reagentPrice) {
      if (!tpm || !wd) return null;
      const D      = tpm / wd;
      const calAVol = mode === 'cartridge' ? 650 : 1350;
      const runDays = calAVol / (21 + 0.8 * D);
      const tests   = runDays * D;
      const cpt     = reagentPrice / tests;
      return { runDays, totalTests: tests, cpt, total: cpt };
    },
  },
};
...
// ─── BLOOD GAS — Easy Diagnosis PT1000 ───────────────────────────────────────

export const BLOODGAS = {
  PT1000: {
    label: 'PT1000',
    brand: 'Easy Diagnosis PT1000 — Blood Gas Analyzer',
    dP: 145715000, dK: 0, dM: 0, dT: 0,
    dMaint: 1500000,
    stability: 21,
    testPresets: [60, 90, 120, 150, 180, 240],
    cartridges: [
      { id: 'pt10_60',  fn: 'Cartridge PT-10 (5 Param)', pack: '60 test/kit',  kit: 60,  dp: 10000000 },
      { id: 'pt10_120', fn: 'Cartridge PT-10 (5 Param)', pack: '120 test/kit', kit: 120, dp: 15429000 },
      { id: 'pt10_200', fn: 'Cartridge PT-10 (5 Param)', pack: '200 test/kit', kit: 200, dp: 17143000 },
    ],
    qc: { id: 'qc123', fn: 'QC Level 1+2+3', pack: '50 test/kit', kit: 50, dp: 665000 },
  },
};
